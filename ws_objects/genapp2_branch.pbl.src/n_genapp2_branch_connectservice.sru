$PBExportHeader$n_genapp2_branch_connectservice.sru
$PBExportComments$Generated Database Connection Service
forward
global type n_genapp2_branch_connectservice from nonvisualobject
end type
end forward

global type n_genapp2_branch_connectservice from nonvisualobject
end type
global n_genapp2_branch_connectservice n_genapp2_branch_connectservice
...
Choose Case is_connectfrom
	...
	Case IS_USE_INIFILE						/*  Populate Database Connection from INI file  */
		string ls_inifile = "F:\SourceControlTest\Git\branchtest_002\genapp2_branch.ini"
...
on n_genapp2_branch_connectservice.create
call super::create
TriggerEvent( this, "constructor" )
end on

on n_genapp2_branch_connectservice.destroy
