$PBExportHeader$n_genapp13_connectservice.sru
$PBExportComments$Generated Database Connection Service
forward
global type n_genapp13_connectservice from nonvisualobject
end type
end forward

global type n_genapp13_connectservice from nonvisualobject
end type
global n_genapp13_connectservice n_genapp13_connectservice
...
Choose Case is_connectfrom
	...
	Case IS_USE_INIFILE						/*  Populate Database Connection from INI file  */
		string ls_inifile = "F:\SourceControlTest\Git\release_test003\genapp13.ini"
...
on n_genapp13_connectservice.create
call super::create
TriggerEvent( this, "constructor" )
end on

on n_genapp13_connectservice.destroy
