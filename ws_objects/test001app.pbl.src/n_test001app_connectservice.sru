$PBExportHeader$n_test001app_connectservice.sru
$PBExportComments$Generated Database Connection Service
forward
global type n_test001app_connectservice from nonvisualobject
end type
end forward

global type n_test001app_connectservice from nonvisualobject
end type
global n_test001app_connectservice n_test001app_connectservice
...
Choose Case is_connectfrom
	...
	Case IS_USE_INIFILE						/*  Populate Database Connection from INI file  */
		string ls_inifile = "F:\SourceControlTest\Git\releasetest002\test001app.ini"
...
on n_test001app_connectservice.create
call super::create
TriggerEvent( this, "constructor" )
end on

on n_test001app_connectservice.destroy
