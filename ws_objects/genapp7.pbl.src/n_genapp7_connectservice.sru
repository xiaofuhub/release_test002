$PBExportHeader$n_genapp7_connectservice.sru
$PBExportComments$Generated Database Connection Service
forward
global type n_genapp7_connectservice from nonvisualobject
end type
end forward

global type n_genapp7_connectservice from nonvisualobject
end type
global n_genapp7_connectservice n_genapp7_connectservice
...
Choose Case is_connectfrom
	...
	Case IS_USE_INIFILE						/*  Populate Database Connection from INI file  */
		string ls_inifile = "F:\SourceControlTest\Git\apptest001\genapp7.ini"
...
on n_genapp7_connectservice.create
call super::create
TriggerEvent( this, "constructor" )
end on

on n_genapp7_connectservice.destroy
