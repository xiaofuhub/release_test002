$PBExportHeader$w_genapp12_frame.srw
$PBExportComments$Generated MDI Frame
forward
global type w_genapp12_frame from window
end type
type mdi_1 from mdiclient within w_genapp12_frame
end type
end forward
...
string title = "Frame"
string menuname = "m_genapp12_frame"
...
global w_genapp12_frame w_genapp12_frame

type variables
n_genapp12_sheetmanager inv_sheetmgt
end variables

forward prototypes
public function long of_getsheetcount ()
public function integer of_sheetisclosing (readonly w_genapp12_basesheet aw_sheet)
...
string ls_sheets[]  = { "w_genapp12_sheet1", "w_genapp12_sheet2", "w_genapp12_sheet3" }
...
inv_sheetmgt = Create n_genapp12_sheetmanager

this.Post Event ue_postopen ( )
end event

on w_genapp12_frame.create
if this.MenuName = "m_genapp12_frame" then this.MenuID = create m_genapp12_frame
this.mdi_1=create mdi_1
this.Control[]={this.mdi_1}
end on

on w_genapp12_frame.destroy
