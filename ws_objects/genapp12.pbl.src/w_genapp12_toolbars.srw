$PBExportHeader$w_genapp12_toolbars.srw
$PBExportComments$Generated MDI Toolbar Configuration
forward
global type w_genapp12_toolbars from window
end type
type rb_floating from radiobutton within w_genapp12_toolbars
end type
type rb_bottom from radiobutton within w_genapp12_toolbars
end type
type rb_right from radiobutton within w_genapp12_toolbars
end type
type rb_top from radiobutton within w_genapp12_toolbars
end type
type rb_left from radiobutton within w_genapp12_toolbars
end type
type cb_done from commandbutton within w_genapp12_toolbars
end type
type cb_visible from commandbutton within w_genapp12_toolbars
end type
type cbx_showtips from checkbox within w_genapp12_toolbars
end type
type cbx_showtext from checkbox within w_genapp12_toolbars
end type
type gb_options from groupbox within w_genapp12_toolbars
end type
end forward
...
global w_genapp12_toolbars w_genapp12_toolbars
...
on w_genapp12_toolbars.destroy
